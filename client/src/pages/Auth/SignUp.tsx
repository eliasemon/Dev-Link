...
import { Gender, SignUpSchema } from '@/valibot/SchemaTypes';
...
const SignUp = () => {
  const form = useForm<v.InferOutput<typeof SignUpSchema>>({
    ...
    defaultValues: {
      ...
      password: '',
      confirmPassword: '',
      gender: Gender.male, // Add gender as a default value'], // Add gender as a default value
    },
  });
  ...
  // Define the fields to render with their specific types
  const fields: Array<keyof v.InferOutput<typeof SignUpSchema>> = [
    'firstName',
    'lastName',
    'userEmail',
  ];

  // Render FormField for common fields
  const renderFormField = (
    fieldName: keyof v.InferOutput<typeof SignUpSchema>,
  ) => (
    <FormField
      key={fieldName}
                ...
                <FormControl>
                  <Select
                    ...
                    onValueChange={(value: string) => {
                      setValue('gender', Gender[value as keyof typeof Gender]);
                    }}
                  >
